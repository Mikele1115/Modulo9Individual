...
class ReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reference" do
    assert_difference("Reference.count") do
      post references_url, params: { reference: { description: @reference.description, name: @reference.name, url: @reference.url } }
    end
  ...
  test "should update reference" do
    patch reference_url(@reference), params: { reference: { description: @reference.description, name: @reference.name, url: @reference.url } }
